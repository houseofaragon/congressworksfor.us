...
const DNCCandidates = (props) => (
	<div id='candidate-wrapper'>
		<h3 className='dnc-header'>~ CANDIDATES ~</h3>
		<a href='https://en.wikipedia.org/wiki/Thomas_Perez'>
			<div className='candidate'>
			  <div id='tom-perez' alt='tom-perez' />
		...
		<a href='https://en.wikipedia.org/wiki/Raymond_Buckley'>
			<div className='candidate'>
			  <div id='ray-buckley' alt='ray-buckley' />
		...
		<a href='https://en.wikipedia.org/wiki/Keith_Ellison'>
			<div className='candidate' >
			  <div id='keith-ellison' alt='keith-ellison' />
		...
		<a href='https://en.wikipedia.org/wiki/Jaime_Harrison'>
			<div className='candidate'>
			  <div id='jaime-harrison' alt='jaime-harrison' />
			  <h1 className='candidate-name'>Jaime Harrison</h1>
			  <ul className='candidate-list'>
			    <li>Chairman of South Carolina Democratic Party</li>
			    <li>40-years old</li>
			    <li>Food stamps recipient</li>
			    <li>Only chair that will have over $160,000 of student loan debt</li>
			    <li>A Clinton favorite</li>
			    <li>Rebuild the party 'grassroots' ground up</li>
			  </ul>
			</div>
		</a>
		<a href='https://en.wikipedia.org/wiki/Sally_Boynton_Brown'>
			<div className='candidate' >
			  <div id='sally-brown' alt='sally-brown' />
